...
<script>
    ...
    for (var i=0;i<4;i++){
        ...
        document.getElementById('myTable').innerHTML+="<tr class='row'><td>date"+i+"</td><td>hostel_name"+i+"</td><td>room_no"+i+"</td>\n\
<td>roll_no"+i+"</td><td>name"+i+"</td><td><input name='att"+i+"' id='pre"+i+"' type='radio' /></td><td><input name='att"+i+"' id='abs"+i+"'type='radio' /></td></tr><br>";
...
<script>
    var newvar=document.getElementsByClassName('row');
    alert('hey');
    function setColor(){
       // alert('hey');
        ...
        var y= 'abs' + i;
            alert(i);
           alert(status[i]);
            if (document.getElementById(x).checked===true && status[i]!=='approved'){
       //     alert(i);
         //   alert("*********");
         status[i]='approved';
                newvar[i].style.background='green';
            }
           else if (document.getElementById(y).checked===true &&& status[i]!=='denied'){
             //   alert(i);
           // alert("--------");
                status[i]='denied';
                newvar[i].style.background='red';
            }else{
                status[i]='pending';
                newvar[i].style.background='white';
            }
        }
    }
