...
<div class="content">
  ...
  <div class="dropdown-content">
    ...
    <div style="text-align: center;width:80%; height: 80%; justify-content: center; margin-left:5%;">
       <h2>PREVIOUS RECORDS OF VISITORS</h2>
...
<table id="myTable">
 ...
 <label style="color:white;"for="room_no">Room no</label><br>
  ...
  <input type="checkbox" id="visitor_name" name="visitor_name" value="visitor_name" onclick="myFunction1();">
 <label style="color:white;"for="visitor_name">Visitor's Name</label><br>
...
switch($usertype){
	...
	break;
	case "WARDEN":
	$query="select * from visitor where hostel_name='munneru'";
   
	break;
	case "CARETAKER":
	$query="select * from visitor where hostel_name='Bhima'";
...
var vname = <?php echo json_encode($arr5); ?>;
...
<td>"+name1[i]+"</td><td>"+hostel_name[i]+"</td><td>"+room_no[i]+"</td><td>"+vname[i]+"</td></tr><br>";
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    td6 = tr[i].getElementsByTagName("td")[5];
      ...
      if (document.getElementById('visitor_name').checked===true){
        ...
        var createClickHandler =  function(row) 
            {
                return function() { 
                                        ...
                                        sessionStorage.setItem("ChiefWardenPageView","Visitor");
