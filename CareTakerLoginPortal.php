...
function myFunction() {
  ...
  if (x.className === "topnav") {
    ...
    <form class="modal-content" method="post" action="CaretakerSuccess.php" style="background-color:rgba(255,255,255,1); height: 100%; border-style: solid; max-width: 500px; heightmargin:auto;  text-align: center; vertical-align:middle; margin-top: 0vh; background-color: white;background-color:rgba(255,255,255,0.9);">
    

    <div class="container">
       <img src="avatar.jpg" alt="Avatar" class="avatar">
   <h2 style="font-size:5vh;">CARETAKER LOGIN PORTAL</h2>
...
<button type="submit" style="display: none;" class="btn" onclick="location.href='CaretakerDashboard.php'">Login</button>
  </div>
    </form>
</div>
