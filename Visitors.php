...
<div class="container" style="width:85%; justify-content: center; text-align: center;">
    ...
    <div class="row">
      ...
      <div class="col-75">
           <input type="text" id="visitor_name" name="visitor_name" placeholder="Enter visitor's name">
      </div>
    </div>
      ...
      <div class="row">
      <div class="col-25">
        <label for="visitor_phone">Visitor's Phone No:</label>
      </div>
      <div class="col-75">
           <input type="text" id="visitor_phone" name="visitor_phone" placeholder="Enter visitor's phone no">
      </div>
    </div>
      <div class="row">
      <div class="col-25">
