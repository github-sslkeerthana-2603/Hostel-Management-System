...
<div class="content">
  ...
  <div class="dropdown-content">
    ...
    <div style="text-align: center;width:80%; height: 80%; justify-content: center; margin-left:5%;">
        ...
        <div class="row">
  <div class="column">
      <div class="card"onclick="location.href='OutingRecChiefWarden.php'" style="background-image:url('blu.jpg'); background-size: cover; background-repeat: no-repeat; ">
      <h3>OUTING PORTAL</h3>
    </div>
  </div>

  <div class="column"  >
      <div class="card" onclick="location.href='VisitorsRecChiefWarden.php'" style="background-image: url('green.jpg'); background-size: cover; background-repeat: no-repeat; ">
      <h3>VISITOR'S PORTAL</h3>
    </div>
  </div>
  
  <div class="column">
      <div class="card" onclick="location.href='ComplaintsRecChiefWarden.php'"style="background-image: url('orange.jpg'); background-size: cover; background-repeat: no-repeat; " >
  ...
  <div class="column">
      <div class="card"  onclick="location.href='StudentInfoRecChiefWarden.php'" style="background-image: url('brown.jpg'); background-size: cover; background-repeat: no-repeat; " >
...
function closeNav() {
    flag=0;
    //document.getElementByClass("Sidenav").style.transition = "0.5s";
    //document.getElementByClass("Sidenav a").style.transition = "0.5s";
