...
<table id="myTable">
 ...
 <input type="checkbox" id="fac_id" name="fac_id" value="fac_id" onclick="myFunction1();">
<label style="color:white;"for="fac_id"> Faculty ID</label><br>
...
<label  style="color:white;" for="designation">Designation</label><br>
...
<script>
    ...
    document.getElementById('myTable').innerHTML+="<tr class='row'><td>fac_id"+i+"</td><td>name"+i+"</td><td>designation"+i+"</td>\n\
<td>hostel"+i+"</td></tr><br>";
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
      ...
      if (document.getElementById('fac_id').checked===true){
