...
<div class="content">
  ...
  <div class="dropdown-content">
    ...
    <div style="text-align: center;width:80%; height: 80%; justify-content: center; margin-left:5%;">
       <h2>RECORDS OF REGISTRATIONS</h2>
...
<table id="myTable">
 ...
 <label style="color:white;"for="room_no">Room no</label><br>
  ...
  <input type="checkbox" id="branch" name="branch" value="branch" onclick="myFunction1();">
...
?>
<script>
var app = <?php echo json_encode($arr1); ?>;
var roll_no = <?php echo json_encode($arr2); ?>;
var name1 = <?php echo json_encode($arr3); ?>;
var status1 = <?php echo json_encode($arr9); ?>;

var branch = <?php echo json_encode($arr5); ?>;
var date = <?php echo json_encode($arr6); ?>;
var hostel_name = <?php echo json_encode($arr7); ?>;
var room_no = <?php echo json_encode($arr8); ?>;
for (var i=0;i<app.length;i++){
        document.getElementById('myTable').innerHTML+="<tr class='row'><td>"+app[i]+"</td><td>"+date[i]+"</td></td><td>"+roll_no[i]+"</td>\n\
<td>"+name1[i]+"</td><td>"+hostel_name[i]+"</td><td>"+room_no[i]+"</td><td>"+branch[i]+"</td></tr><br>";
        ...
        var createClickHandler =  function(row) 
            {
                return function() { 
                                       /* var cell = row.getElementsByTagName("td")[0];
                                        ...
                                        alert("id:" + id);*/
                                        sessionStorage.setItem("ChiefWardenPageView","Registration");
