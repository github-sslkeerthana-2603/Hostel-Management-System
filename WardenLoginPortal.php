...
<div  class="topnav" id="topBar1" id="myTopnav" style="background-color:rgba(0,95,255,1); ">
        ...
        <a href="ChiefWardenDashboard.php" >Registration</a>
...
function myFunction() {
  ...
  '
    <form class="modal-content" method="post" action="WardenSuccess.php" style="background-color:rgba(255,255,255,1); height: 100%; border-style: solid; max-width: 500px; heightmargin:auto;  text-align: center; vertical-align:middle; margin-top: 0vh; background-color: white;background-color:rgba(255,255,255,0.9);">
    

    <div class="container">
       <img src="avatar.jpg" alt="Avatar" class="avatar">
   <h2 style="font-size:5vh;">WARDEN LOGIN PORTAL</h2>
...
<button type="submit" style="display: none;" onclick="location.href='WardenDashboard.php'" class="btn">Login</button>
  </div>
    </form>
</div>
