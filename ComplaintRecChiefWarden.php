...
<div class="content">
  ...
  <div class="dropdown-content">
    ...
    <div style="text-align: center;width:80%; height: 80%; justify-content: center; margin-left:5%;">
       <h2>PREVIOUS RECORDS OF COMPLAINTS</h2>
...
<table id="myTable">
  <tr class="header">
    ...
    <th style="width:33%;">Application no</th>
    <th style="width:33%;">Date</th>
    <th style="width:33%;">Complaint category</th>
  </tr>
 ...
 <input type="checkbox" id="comp_cat" name="comp_cat" value="comp_cat" onclick="myFunction1();">
 <label style="color:white;"for="comp_cat"> Complaint Category</label><br>
...
$sql="select status from complaintapplications";
...
var status1=<?php echo json_encode($arr3); ?>;
//alert(status1);

var date=<?php echo json_encode($arr1); ?>;
var cat =<?php echo json_encode($arr2); ?>;
  //alert("status1");
    for (var i=0;i<app.length;i++){
        
        document.getElementById('myTable').innerHTML+="<tr class='row'><td>"+app[i]+"</td><td>"+date[i]+"</td></td><td>"+cat[i]+"</td></tr><br>";
...
function myFunction() {
  ...
  for (i = 0; i < tr.length; i++) {
    ...
    td2 = tr[i].getElementsByTagName("td")[1];
      ...
      if (document.getElementById('comp_cat').checked===true){
  ...
  td2 = tr[i].getElementsByTagName("td")[1];
    ...
    if (td3){
      ...
      if ((td1 && txtValue1.toUpperCase().indexOf(filter) > -1) ||(td2 && txtValue2.toUpperCase().indexOf(filter) > -1)
              ||(td3 && txtValue3.toUpperCase().indexOf(filter) > -1) ) {
        tr[i].style.display = "";
      } else {
        ...
        var createClickHandler =  function(row) 
            {
                return function() { 
                                        ...
                                        sessionStorage.setItem("ChiefWardenPageView","Complaint");
