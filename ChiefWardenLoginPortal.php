...
<div  class="topnav" id="topBar1" id="myTopnav" style="background-color:rgb(0,95,255); ">
...
function myFunction() {
  ...
  if (x.className === "topnav") {
    ...
    <form class="modal-content" method="post" action="ChiefWardenSuccess.php" style="background-color:rgba(255,255,255,1); height: 100%; border-style: solid; max-width: 500px; heightmargin:auto;  text-align: center; vertical-align:middle; margin-top: 0vh; background-color: white;background-color:rgba(255,255,255,0.9);">
    

    <div class="container">
       <img src="avatar.jpg" alt="Avatar" class="avatar">
   <h2 style="font-size:5vh;">CHIEF WARDEN LOGIN PORTAL</h2>
  ...
  <div class="input-container">
   ...
   <button id='but' onclick="func();"class="btn">Login</button>
...
<button style="display: none;" type="submit"  class="btn">Login</button>
<script>
    function func(){
