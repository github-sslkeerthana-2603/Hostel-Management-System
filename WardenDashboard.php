...
<div id="mySidenav" class="sidenav">
    <div style=" height: 5vh;width:100%; margin-bottom: 3vh;background-color: blue; justify-content: center; height: 45px; padding-top: 1vh; padding-bottom: 10px;font-size: 30px;vertical-align: central; text-align: center;">WARDEN</div> 
    <a style="background-color:black; color:white;" href="WardenDashboard.php">Dashboard</a>
...
<div class="content">
    <a style="background-color:black; font-size: 16px;color:white;" href="ComplaintsRecChiefWarden.php">Record of previous complaints </a>
...
<div class="content">
    <a style="background-color:black; font-size: 16px;color:white;" href="RegistrationRecChiefWarden.php">Record of previous registrations</a>
...
<div class="content">
    <a style="background-color:black; font-size: 16px;color:white;" href="ViewRooms.php">View Rooms</a>
...
<div class="content">
    ...
    <a style="background-color:black; font-size: 16px;color:white;" href="StaffInfoRecChiefWarden.php">Staff Information</a>

</div>
<button class="collapsible">Hostel Maintainance
  <i class="fa fa-caret-down"></i>
</button>
<div class="content">
...
<div class="content">
    <a style="background-color:black; font-size: 16px;color:white;" href="StudentInfoRecWarden.php"> view student attendance</a>
  

    <a style="background-color:black; font-size: 16px;color:white;" href="StaffInfoRecWarden.php"> view staff attendance</a>
  ...
  <div class="dropdown-content">
    ...
    <div style="text-align: center;width:80%; height: 80%; justify-content: center; margin-left:5%;">
        ...
        <div class="row">
  <div class="column">
      <div class="card" onclick="location.href='OutingRecWarden.php'"style="background-image:url('blu.jpg'); background-size: cover; background-repeat: no-repeat; ">
      <h3>OUTING PORTAL</h3>
    </div>
  </div>

  <div class="column"  >
      <div class="card" onclick="location.href='VisitorsRecWarden.php'"style="background-image: url('green.jpg'); background-size: cover; background-repeat: no-repeat; ">
      <h3>VISITOR'S PORTAL</h3>
    </div>
  </div>
  
  <div class="column">
      <div class="card"onclick="location.href='ComplaintsRecWarden.php'" style="background-image: url('orange.jpg'); background-size: cover; background-repeat: no-repeat; " >
  ...
  <div class="column">
      <div class="card"  onclick="location.href='StudentInfoRecWarden.php'" style="background-image: url('brown.jpg'); background-size: cover; background-repeat: no-repeat; " >
  ...
  <div class="column">
      <div class="card" style="background-image: url('violet.jpg'); background-size: cover; background-repeat: no-repeat; " >
      <h3>MAINTAINANCE</h3>
    </div>
  </div>
  <div class="column">
...
for (var j=0;j<coll.length;j++){
        coll[j].addActionListener("mouseover",function(){
              //var content = this.nextElementSibling;
               //content.style.maxHeight = content.scrollHeight + "px";
