...
$query="select * from student_info where roll_no = '$var' ";
...
<div id="mySidenav" class="sidenav">
    ...
    <a id='chk2' style="background-color:black; color:white;" href="WardenDashboard.php">Dashboard</a>
    <a id='chk3' style="background-color:black; color:white;" href="CaretakerDashboard.php">Dashboard</a>
    <a id='chk4' style="background-color:black; color:white;" href="StudentDashboard.php">Dashboard</a>
...
<div class="container" style="width:85%; justify-content: center; text-align: center;">
    ...
    <form style="margin-right:6vw;" method="post" action="ComplaintSuccess.php">
    <div class="row">
      <div class="col-25">
    ...
    <div class="row">
      ...
      <div class="col-75">
          <select>
          <option name="complaint_category">select category</option>
          <option name="complaint_category">Cleanliness and hygiene</option>
          <option name="complaint_category">Electrical</option>
          <option name="complaint_category">Mechanical</option>
          <option name="complaint_category">others</option>
          </select>
      </div>
    </div>
      ...
      <div class="col-75">
          <textarea id="description" name="description" cols="100" rows="4"></textarea>
      </div>
    </div>
      ...
      <div class="col-75">
          <textarea id="report" name="report" cols="100" rows="4"></textarea>
      </div>
    </div>
    ...
    <script>
	document.getElementById('roll_no').value="<?php echo $_SESSION['roll']; ?>";
   document.getElementById('name').value='<?php echo $_SESSION["sname"];?>';
   document.getElementById('phone').value='<?php echo $_SESSION["mno"];?>';
   document.getElementById('email').value='<?php echo $_SESSION["mail"];?>';
   document.getElementById('year').value='<?php echo $_SESSION["year"];?>';
   document.getElementById('branch').value='<?php echo $_SESSION["branch"];?>';
   document.getElementById('section').value='<?php echo $_SESSION["section"];?>';
   document.getElementById('reg_no').value='<?php echo $_SESSION["regno"];?>';
   document.getElementById('room_no').value='<?php echo $_SESSION["roomno"];?>';
   document.getElementById('hostel_name').value='<?php echo $_SESSION["hname"];?>';
